...
public class BinaryTreezigzagPrinting {
	...
	public static void spiralOrZigzagLevelOrder(TreeNode root) {
		...
		boolean directionflag = false;	//Direction flag would take care of the spiral thing
		while (!stack.isEmpty()) {
	...
	public static void main(String[] args) {
		BinaryTreezigzagPrinting bi = new BinaryTreezigzagPrinting();
